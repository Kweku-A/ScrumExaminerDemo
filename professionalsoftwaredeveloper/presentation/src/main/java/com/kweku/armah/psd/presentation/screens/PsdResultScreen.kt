...
import com.kweku.armah.psd.presentation.viewmodels.PsdResultScreenViewModel

@Composable
fun ResultScreenRoute(
    navigateToReview: () -> Unit = {},
    navigateToHome: () -> Unit = {},
    viewModel: PsdResultScreenViewModel = hiltViewModel(),
) {
...
@Composable
private fun PsdResultScreenPreview() {
    PsdResultScreen(FinalScoreUi())
}
